  ...
  return (
    <div className="career-reference apply-page">
      <main>
        ...
        <div className="wrap form-wrap"><section className="form-card"><CareerApplicationForm initialRole={selected} jobs={jobs} /></section><aside><div className="side-card"><h3>What happens next?</h3><p>Our team reviews your application, completes a quick phone/text screen, and schedules qualified candidates within two business days.</p></div><div className="side-card"><h3>Résumé / CV required</h3><p>Please attach your résumé or CV (PDF, DOC, or DOCX up to 3 MB) so our team can review your background.</p></div><div className="side-card"><h3>Need help?</h3><p>Hiring contact: Donna Williams<br />donnaw@prevaclub.com<br />586-343-9099</p></div></aside></div>
      </main>
    </div>
  );
}
