...
export default async function CareerJobPage({ params }) {
  ...
  const jsonLd = {
    ...
    hiringOrganization: { '@type': 'Organization', name: 'Preva Kitchen', sameAs: 'https://prevakitchen.com' },
